...
public final class Service1Grpc {
  ...
  public static io.grpc.MethodDescriptor<ds.service1.RequestMessage,
      ds.service1.ResponseMessage> getActiveAlarmMethod() {
    io.grpc.MethodDescriptor<ds.service1.RequestMessage, ds.service1.ResponseMessage> getActiveAlarmMethod;
    if ((getActiveAlarmMethod = Service1Grpc.getActiveAlarmMethod) == null) {
      synchronized (Service1Grpc.class) {
        if ((getActiveAlarmMethod = Service1Grpc.getActiveAlarmMethod) == null) {
          Service1Grpc.getActiveAlarmMethod = getActiveAlarmMethod = 
  ...
  public static abstract class Service1ImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void activeAlarm(ds.service1.RequestMessage request,
  ...
  public static final class Service1FutureStub extends io.grpc.stub.AbstractStub<Service1FutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ds.service1.ResponseMessage> activeAlarm(
